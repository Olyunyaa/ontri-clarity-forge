...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "how.1.desc": "A free call about your goals, your processes, and where time is being lost. No forms, no homework.",
  ...
  nl: {
    ...
    "how.1.desc": "Een vrijblijvend gesprek over uw doelen, uw processen en waar tijd verloren gaat. Geen formulieren, geen huiswerk.",
  ...
  ru: {
    ...
    "how.1.desc": "Бесплатный созвон: ваши цели, процессы и где теряется время. Без анкет и домашних заданий.",
